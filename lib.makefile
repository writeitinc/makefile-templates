# This Makefile is based on a template (lib.makefile version 2.0.0).
...
release: dirs $(LIBRARIES)

.PHONY: debug
debug: DEBUG = -fsanitize=address,undefined
debug: OPTIM = -g
debug: dirs $(LIBRARIES)
...
.PHONY: dirs
dirs: $(STATIC_OBJ_DIR)/ $(SHARED_OBJ_DIR)/ $(LIB_DIR)/ $(BIN_DIR)/
