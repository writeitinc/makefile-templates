# This Makefile is based on a template (lib+tests+examples.makefile version 3.0.0).
...
TESTS = $(patsubst $(TEST_SOURCE_DIR)/%.c, $(TEST_BIN_DIR)/%, $(TEST_SOURCES))
...
$(TEST_BIN_DIR)/%: $(INTERMEDIATE_DIR)/%.test.o $(LIBRARIES)
	$(CC) -o $@ $< \
