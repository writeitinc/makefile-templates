# This Makefile is based on a template (lib+tests+examples.makefile version 2.0.0).
...
EXECUTABLES = # $(BIN_DIR)/some-example $(BIN_DIR)/some-test
...
.PHONY: dirs
dirs: $(STATIC_OBJ_DIR)/ $(SHARED_OBJ_DIR)/ $(EXAMPLE_OBJ_DIR)/ $(TEST_OBJ_DIR)/ $(LIB_DIR)/ $(BIN_DIR)/
